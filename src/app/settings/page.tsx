  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 max-w-2xl mx-auto">
        {/* 頁面標題 */}
        <h1 className="text-2xl font-bold text-keylio-text-primary">設定</h1>
            ...
            <CardContent className="pt-5 divide-y divide-keylio-border-primary">
              ...
              <div className="pb-4">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-keylio-bg-tertiary transition-colors"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="font-medium text-keylio-text-primary">生物辨識</p>
              ...
              <div className="pt-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="font-medium text-keylio-text-primary">備份助記詞</p>
                      <p className="text-xs text-keylio-text-muted">
                        檢視並備份您的錢包恢復短語
                      </p>
                    </div>
